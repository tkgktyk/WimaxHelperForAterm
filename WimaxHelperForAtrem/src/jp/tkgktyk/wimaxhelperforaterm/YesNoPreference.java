...
public class YesNoPreference extends DialogPreference {
    ...
    public YesNoPreference(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
			...
			public boolean onPreferenceChange(Preference preference, Object newValue) {
				boolean r = (Boolean)newValue;
				if (r)
					_onYesClicked.onYesClicked(preference);
				return r;
			}
		});
    }
    ...
    public void setOnYesClickedListener(OnYesClickedListner listener) {
    	_onYesClicked = listener;
    }
